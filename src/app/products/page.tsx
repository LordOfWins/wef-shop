...
export const metadata: Metadata = {
  title: '전체 상품',
  description:
    'WEF 윈도우·MS 오피스 라이선스 전체 상품을 확인하세요. Windows 10/11, Office 2024/2021/2019/2016/365 최저가 즉시 발송.',
}
            ...
            return (
              ...
              >
                <div className="relative aspect-[4/3] bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center overflow-hidden">
                  ...
                  {/* ── 할인율 리본 (우상단) ── */}
                  {/* Tailwind-only: 커스텀 CSS 없이 순수 유틸리티로 구현 */}
                  {discountRate > 0 && !isOutOfStock && (
                    <div className="absolute top-3 -right-1 z-10">
                      {/* 리본 본체 */}
                      <div className="relative bg-gradient-to-br from-red-500 to-red-600 text-white text-[11px] sm:text-xs font-extrabold leading-none px-2.5 sm:px-3 py-1.5 rounded-l-md shadow-md">
                        {discountRate}% OFF
                        {/* 리본 꼬리(접힌 부분) */}
                        <div
