...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      '구매 확인 이메일에 상세한 설치 가이드 링크가 포함되어 있습니다. Windows의 경우 설정 → 시스템 → 제품 인증에서 "제품 키 변경"을 클릭하여 입력하시면 됩니다. Office는 office.com/setup에서 설치하실 수 있습니다. 어려우시다면 원격 지원도 가능하니 편하게 문의해주세요.',
  },
  {
